...
public class CreateAccount_isEnable_isDisplayed {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		if (driver.findElement(By.id("email_create")).isDisplayed()
			...
			driver.findElement(By.id("email_create")).sendKeys("bhhhaaavvvyyk@gmail.com");
			driver.findElement(By.id("SubmitCreate")).click();
		} else {
			System.out.println("email id of create account is not exit hence coming out of the test");
			System.exit(0);
		}
...
//			driver.findElement(By.id("years")).sendKeys("2010  ");
    ...
    //drag and drop concept  selectByVisibleText,  selectByValue, selectByIndex
		...
		// Address //here we using string with if conditions and checking first name and
		// last and add first and last name matching or not.
		...
		// add firstname and last name we are changing by using clear command firstname
		// and lastname will be
		// same add firstname and last name will change

		driver.findElement(By.id("firstname")).clear();
		driver.findElement(By.id("lastname")).clear();
		Thread.sleep(2000);
		driver.findElement(By.id("firstname")).sendKeys("kalva");
		driver.findElement(By.id("lastname")).sendKeys("bhavya");
