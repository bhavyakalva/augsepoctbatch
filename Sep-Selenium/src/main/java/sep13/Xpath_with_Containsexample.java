...
public class Xpath_with_Containsexample { // it is most usefull when we have dynamic elements we can use contains with
								// starting part of value of an attribute it willcheck weither it is in starting
								// middle or end it should contain the value we gave for the attribute that's it it can be anywhere
