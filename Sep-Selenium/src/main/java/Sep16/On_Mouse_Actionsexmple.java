...
public class On_Mouse_Actionsexmple {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement Tea=driver.findElement(By.xpath("/html/body/div[1]/div[1]/nav/div/div/ul/li[1]/ul/li/mega-nav-template/div/div/div/left-subcategory-template/div/div/div/div[1]/ul/li[4]/a"));
