...
public class ActionsEXDoubleclick {
	...
	// to move the curser,.click().sendKeys("tomato")is used to search and click on the box and senkeys tomato and
	// .doubleclick() is used to click double and build().perform() is used to execute the command
