...
public class LED_TV_LowCost extends ColorTV {// we used super key in this prgrm
	...
	void soundSystem() {
		...
		System.out.println("Name of the TV is " + tvName);// we are using this line to print the instance variable above-
															// the main method
		System.out.println("Remote " + super.remote);// here weused super key and used instance variable of b/w tv class-
														// as colour tv dont have instance var it used b/w
