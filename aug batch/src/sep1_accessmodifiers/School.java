...
public class School {
	...
	private String schoolAddress = "warangal";
	...
	protected void adminSalary() {// it is accessed with in class and child class
	 ...
	 void playground() { //it is a default method it can access with in class,child class and package and not accessed outside the package 
