...
public abstract class School {// this is abstract class
	public static void main(String[] args) {// we cannot create psvm method but cannot create objects in abstract class
		...
		System.out.println("i am from main method");// we can write anything in main mthd it prints automatically wthout
													// creating obj
	}
...
// we can see thet dep1 dep2 usung abstract mthds but the nfo we are givinh are diff in realtime we use this if we have diff clients& they want 
//diff info we use this abstraction in java dep1 extends school and use abstrctmthd and give info differently and dep2 extends school and use 
//abtract mthds and give info differently
