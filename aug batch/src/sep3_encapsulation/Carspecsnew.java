...
public class Carspecsnew {
	Company car;  //here we created the object of the company in the instance variable level because we can use it in all methods if we create in main 
	...
	public void display() {
		...
		String carname = car.getcarname();//with help of thw car we created in instance variable we are calling the get methods here
